...
list_files = [f_dir + 'XeKr_Mix_273K_1Bar_Kr_1A_old/FitLoading/' + 'XeKr_Mix_273K_1Bar_Kr_1A_test_Kr.csv', 
              f_dir + 'XeKr_Mix_273K_10Bar_Kr_1A_old/FitLoading/' + 'XeKr_Mix_273K_10Bar_Kr_1A_test_Kr.csv',
              f_dir + 'XeKr_Mix_273K_1Bar_Kr_1A_old/FitLoading/' + 'XeKr_Mix_273K_1Bar_Kr_1A_test_Xe.csv',
              f_dir + 'XeKr_Mix_273K_10Bar_Kr_1A_old/FitLoading/' + 'XeKr_Mix_273K_10Bar_Kr_1A_test_Xe.csv']

list_stats = [[0.85, 0.93, 2.8], 
              [0.83, 3.4, 8.7], 
              [0.93, 1.7, 4.8], 
              [0.95, 4.3, 8.1]]
...
for file in list_files:
    ...
    if(search("_Xe", file)):
        columnname = 'Xe_prediction'
        filename1 = "Xe_"
    else:
        columnname = 'Kr_prediction'
        filename1 = "Kr_"
    ...
    plt.xlabel(r"GCMC Loading [cm$^{\rm 3}$/cm$^{\rm 3}$]", fontsize = fsize, fontweight='bold')
    plt.ylabel(r"Predicted Loading [cm$^{\rm 3}$/cm$^{\rm 3}$]", fontsize = fsize, fontweight='bold')
    ...
    plt.text(0.75, 0.20, r"R$^{\rm 2}$ = " + str(list_stats[a][0]) + '\n' + 
             'MAE = ' + str(list_stats[a][1]) + r" cm$^{\rm 3}$/cm$^{\rm 3}$" + '\n' + 
             'RMSE = ' + str(list_stats[a][2]) + r" cm$^{\rm 3}$/cm$^{\rm 3}$" + '\n', 
...
get_concat_v_cut(left, right).save('Figure_3_new.png')