...
img_dir = master_dir + '/'
list_im = [img_dir + 'XeKr_Mix_273K_1Bar_Kr_1A/FitLoading/' + 'XeKr_Mix_273K_1Bar_Kr_1A_Selectivity_test.png', 
           img_dir + 'XeKr_Mix_273K_10Bar_Kr_1A/FitLoading/' + 'XeKr_Mix_273K_10Bar_Kr_1A_Selectivity_test.png']
#           img_dir + 'XeKr_Mix_273K_1Bar_Kr_1A/FitLoading/' + 'XeKr_Mix_273K_1Bar_Kr_1A_Selectivity_remove_outliers_test.png', 
#           img_dir + 'XeKr_Mix_273K_10Bar_Kr_1A/FitLoading/' + 'XeKr_Mix_273K_10Bar_Kr_1A_Selectivity_remove_outliers_test.png']
#list_names = ["273 K, 1 Bar", "273 K, 10 Bar", "273 K, 1 Bar", "273 K, 10 Bar"]
list_names = ["273 K, 1 Bar", "273 K, 10 Bar"]
#list_labels = ["a", "b", "c", "d"]
list_labels = ["a", "b"]
...
def get_concat_v_cut(im1, im2):
    ...
    dst.paste(im2, (0, im1.height))
    return dst
left = get_concat_h_cut(imgs[0], imgs[1]).save('new-Figure_4_SI.png')
#right = get_concat_h_cut(imgs[2], imgs[3])

#get_concat_v_cut(left, right)