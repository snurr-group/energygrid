...
img_dir = master_dir + '/'
list_im = [img_dir + 'Propane_298K_10Bar_CH3_1A/cm3overcm3/' + 
           'Propane_298K_10Bar_CH3_1A_RF_Histogram_Textural_train.png',
           img_dir + 'Propane_298K_10Bar_CH3_1A/cm3overcm3/' + 
           'Propane_298K_10Bar_CH3_1A_RF_Textural_Stats_train.png']
list_names = ["Propane 10 Bar\nRF\nEnergy Histogram + \nTextural Properties", 
              "Propane 10 Bar\nRF\nEnergy Histogram + \nTextural Properties + \nEnergy Statistics"]
list_labels = ["a", "b", "c"]
...
def get_concat_v_cut(im1, im2):
    ...
    dst.paste(im2, (0, im1.height))
    return dst
get_concat_h_cut(imgs[0], imgs[1]).save('Figure_S14.png')