...
list_im = [img_dir + 'Propane_298K_10Bar_CH3_1A/cm3overcm3/' + 
           'Propane_298K_10Bar_CH3_1A_RF_Histogram_Textural_test.png',
           img_dir + 'Propane_298K_10Bar_CH3_1A/cm3overcm3/' +
           'Propane_298K_10Bar_CH3_1A_RF_Textural_Stats_test.png']
...
def get_concat_v_cut(im1, im2):
    ...
    dst.paste(im2, (0, im1.height))
    return dst
get_concat_h_cut(imgs[0], imgs[1]).save('Figure_9.png')