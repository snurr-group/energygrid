...
p_robust <- 
  ...
  #ylim(c(-12.5, 2.5))
  geom_text(data=filter(hyper_tuned_hist, upper==Inf), aes(binwidth+0.10, lower-1.0, label=format(MAE, digits=3)), color="purple", size=3)  # add the MAE of the training data/fit to the plot
...
* Run calculations of the top CCDC candidates and confirm results. (get from mateo:ScreenCSD, ExtraCSD2, and ExtraCSD3)
  ...
  * Textural properties of the top 25 are in Box:from_arun_apr2_2018_ben_top_25
