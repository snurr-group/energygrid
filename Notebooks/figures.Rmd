...
* If our model is solely based on LJ interactions, shouldn't the non-CNPS structures perform just as well?  Yes.  Add some analysis to the SI on non-CNPS, dimensionality, etc., to see if there's a new dependence.
...
### z-scoring
* Shift the bin offset to work outward from zero.  That will make the robustness figure align better, too.
