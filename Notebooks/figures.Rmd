...
hmof_fine_h2_grid <- 
  ...
  select(-str_id)
hmof_fine_hist_sets <- partition_data_subsets(hmof_fine_h2_grid, hmof_y_to_join, DATA_SPLIT)
...
* Check the new parameters for the bottom bin in default_binspec.  Does it use enough samples?  How is it (and the model type) justified?
