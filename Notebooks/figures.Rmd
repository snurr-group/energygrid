...
* Send Scotty list of top CCDC candidates once we have a (near-final?) model: but first, remove the z-scoring
* REMOVE Z-SCORING
...
* Check UFF params vs. SI of accurate pore volume paper (`ongari_accurate_2017`)
