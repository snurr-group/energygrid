...
p_si_ch4_vs_h2 <- 
  ...
  xlab(expression(CH[4]~uptake~(cm^3/cm^3))) +
  ylab(expression(H[2]~uptake~(g/L))) +
  labs(color="Void\nfraction")
p_si_ch4_vs_h2  # not sure what happened to this figure.  More investigation required
p_si_ch4_vs_h2 %>% save_si_fig("ch4_vs_h2_ads.png", bheight=5)
...
### Consistency between different model formulations
hMOF vs. ToBaCCo, etc.
...
### New figures for SI
* TODO: get these from the Desktop SI FIGS file once ready
