...
* Send Scotty list of top CCDC candidates once we have a (near-final?) model, and request the unit cell file for the CCDC MOFs

### New with FH
* Compile the revised hMOF and ToBaCCo energies.  Do they work in the model?
* Generate grids for CH4
